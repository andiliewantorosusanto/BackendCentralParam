...
public class RateBunga implements Serializable {
    ...
    public RateBunga(Integer id, String namaSkema, Integer loanType, Integer produk, Integer jenisKendaraan,
            Integer kondisiKendaraan, Integer startTahunKendaraan, Integer endTahun, Date startBerlaku, Date endBerlaku,
            Float tenor1, Float tenor2, Float tenor3, Float tenor4, Integer tenor5Periode1, Integer tenor5Periode2,
            Float tenor5Rate1, Float tenor5Rate2, Integer tenor6Periode1, Integer tenor6Periode2, Float tenor6Rate1,
            Float tenor6Rate2, Integer tenor7Periode1, Integer tenor7Periode2, Float tenor7Rate1, Float tenor7Rate2,
            Integer tenor8Periode1, Integer tenor8Periode2, Float tenor8Rate1, Float tenor8Rate2,
            Integer tenor9Periode1, Integer tenor9Periode2, Float tenor9Rate1, Float tenor9Rate2,
            Integer tenor10Periode1, Integer tenor10Periode2, Float tenor10Rate1, Float tenor10Rate2,
            String operatorAwal, String operatorAkhir, Integer statusApproval, String remarks, Integer isRejected,
            Integer isApproved, Integer jenisPembiayaan, Integer tujuanPenggunaan, Integer cluster, Integer program,
            Date createdDate, Date updatedDate, Long updatedBy, Long createdBy, Integer tipeKonsumen) {
        this.id = id;
