...
public class vwDataKomponenPH {
    ...
    public vwDataKomponenPH() {
    }

    public vwDataKomponenPH(Integer id, String namaSkema, Integer tipeKonsumen, String tipeKonsumenName, Integer jenisPembiayaan, String jenisPembiayaanName, String jenis, String addm, String addb, Integer statusApproval, String remarks, Integer isRejected, Integer isApproved) {
        this.id = id;
    ...
    public vwDataKomponenPH id(Integer id) {
        setId(id);
        return this;
    }

    public vwDataKomponenPH namaSkema(String namaSkema) {
        setNamaSkema(namaSkema);
        return this;
    }

    public vwDataKomponenPH tipeKonsumen(Integer tipeKonsumen) {
        setTipeKonsumen(tipeKonsumen);
        return this;
    }

    public vwDataKomponenPH tipeKonsumenName(String tipeKonsumenName) {
        setTipeKonsumenName(tipeKonsumenName);
        return this;
    }

    public vwDataKomponenPH jenisPembiayaan(Integer jenisPembiayaan) {
        setJenisPembiayaan(jenisPembiayaan);
        return this;
    }

    public vwDataKomponenPH jenisPembiayaanName(String jenisPembiayaanName) {
        setJenisPembiayaanName(jenisPembiayaanName);
        return this;
    }

    public vwDataKomponenPH jenis(String jenis) {
        setJenis(jenis);
        return this;
    }

    public vwDataKomponenPH addm(String addm) {
        setAddm(addm);
        return this;
    }

    public vwDataKomponenPH addb(String addb) {
        setAddb(addb);
        return this;
    }

    public vwDataKomponenPH statusApproval(Integer statusApproval) {
        setStatusApproval(statusApproval);
        return this;
    }

    public vwDataKomponenPH remarks(String remarks) {
        setRemarks(remarks);
        return this;
    }

    public vwDataKomponenPH isRejected(Integer isRejected) {
        setIsRejected(isRejected);
        return this;
    }

    public vwDataKomponenPH isApproved(Integer isApproved) {
